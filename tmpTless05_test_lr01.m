...
dir_test_shuffle = fullfile(dir_Tless05,['test_shuffle']);
...
if ~exist(mat_test_feat,'file')
    ...
    if abs(lr-0.01)<1e-10
        net_caffemodel = fullfile(dir_Tless05,'caffenet-model',...
            ['fix' int2str(fix_layer) '-caffenet_' str_para '_iter_4000.caffemodel']);
    else if abs(lr-0.001)<1e-10
            net_caffemodel = fullfile(dir_Tless05,'caffenet-model',...
                ['fix' int2str(fix_layer) '-caffenet_' str_para '_iter_8000.caffemodel']);
        end;
    end;
